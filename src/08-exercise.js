...
import { GroupNode, SphereNode, AABoxNode } from './nodes.js';
import { RasterVisitor, RasterSetupVisitor } from './rastervisitor.js';
...
window.addEventListener('load', () => {
  ...
  const shader = new Shader(gl, 'basic-vertex-shader.glsl', 'basic-fragment-shader.glsl');
  // render
