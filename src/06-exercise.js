...
window.addEventListener('load', () => {
  console.log(
    Matrix.rotation(new Vector(1, 0, 0, 0), 10).mul(
      new Vector(2, 3, 4, 5)
    )
  );
  console.log(Matrix.rotation(new Vector(0, 1, 0, 0), 10));
  console.log(Matrix.rotation(new Vector(0, 0, 1, 0), 10));
  ...
  const objects = [
    ...
    new Sphere(new Vector(-0.5, -0.2, -1.5, 1), 0.4, new Vector(0, 0, 0.3, 1))
  ];
